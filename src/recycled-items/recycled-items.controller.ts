...
export class RecycledItemsController {
  ...
  @ApiOperation({
    summary: 'Listar productos reciclados con paginación y filtro exclusivo',
  })
  @ApiQuery({
    name: 'page',
    required: false,
  ...
  @ApiQuery({
    ...
    type: String,
    description:
      'Filtrar por ID de producto. Si no se envia retorna todos los items de reciclado del Usuario.',
  })
  @ApiResponse({
    status: 200,
    description: 'Listado de productos reciclados retornado correctamente',
  })
  ...
  @ApiResponse({
    status: 404,
    description: 'No se encontró el producto reciclado',
  })
  @ApiResponse({ status: 500, description: 'Error interno del servidor' })
  ...
  @ApiResponse({
    status: 201,
    description: 'Producto reciclado creado exitosamente',
  })
  @ApiResponse({
    status: 400,
    description: 'Datos inválidos para crear el producto reciclado',
  })
  ...
  @ApiParam({
    name: 'id',
    description: 'UUID del producto reciclado a actualizar',
  })
  @ApiResponse({
    status: 200,
    description: 'Producto reciclado actualizado correctamente',
  })
  @ApiResponse({
    status: 404,
    description: 'No se encontró el producto reciclado a actualizar',
  })
  @ApiResponse({
    status: 500,
    description: 'Error al actualizar el producto reciclado',
  })
  async update(
    @Param('id', ParseUUIDPipe) id: string,
    @Body() body: UpdateRecycledItemDto,
  ) {
  ...
  @ApiParam({
    name: 'id',
    description: 'UUID del producto reciclado a eliminar',
  })
  @ApiResponse({
    status: 204,
    description: 'Producto reciclado eliminado correctamente',
  })
  @ApiResponse({
    status: 404,
    description: 'No se encontró el producto reciclado a eliminar',
  })
  @ApiResponse({
    status: 409,
    description: 'No se puede eliminar el producto reciclado (conflicto)',
  })
