...
export class RecyclePricesController {
  ...
  @ApiResponse({
    status: 200,
    description: 'Listado de materiales a reciclar retornado correctamente',
  })
  ...
  @ApiResponse({
    status: 404,
    description: 'No se encontró el material a reciclar',
  })
  @ApiResponse({ status: 500, description: 'Error interno del servidor' })
  ...
  @ApiResponse({
    status: 201,
    description: 'Material a reciclar creado exitosamente',
  })
  @ApiResponse({
    status: 400,
    description: 'Datos inválidos para crear el material a reciclar',
  })
  @ApiResponse({
    status: 500,
    description: 'No se pudo crear el material a reciclar',
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'Material a reciclar actualizado correctamente',
  })
  @ApiResponse({
    status: 404,
    description: 'No se encontró el material a reciclar a actualizar',
  })
  @ApiResponse({
    status: 500,
    description: 'Error al actualizar el material a reciclar',
  })
  async update(
  ...
  @ApiResponse({
    status: 204,
    description: 'Material a reciclar eliminado correctamente',
  })
  @ApiResponse({
    status: 404,
    description: 'No se encontró el material a reciclar a eliminar',
  })
  @ApiResponse({
    status: 409,
    description: 'No se puede eliminar el material a reciclar (conflicto)',
  })
